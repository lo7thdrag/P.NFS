...
type
  ...
  public
    ...
    procedure Run(const aDeltaMs: double); virtual;
    // procedure ini akan dijalankan oleh thread;
...
begin
  ...
  if FUpdateInterleave.Cycle > 0 then
  begin
    FUpdateInterleave.Counter := (FUpdateInterleave.Counter + 1);
    FUpdateInterleave.Counter :=
      FUpdateInterleave.Counter mod FUpdateInterleave.Cycle;
  end;
...
begin
  ...
  if FRunInterleave.Cycle > 0 then
  begin
