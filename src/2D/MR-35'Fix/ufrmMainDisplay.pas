...
type
  ...
  TfrmMainFCC = class(TForm)
    ...
    lblStatusGain: TLabel;
    edtStatusGain: TEdit;
    lblStatusLaser: TLabel;
    edtStatusLaser: TEdit;
    edtStatusTrans: TEdit;
    lblStatusTrans: TLabel;
    edtStatusType: TEdit;
    lblStatusType: TLabel;
    edtStatusDetect: TEdit;
    lblStatusDetect: TLabel;
    edtStatusControl: TEdit;
    lblStatusControl: TLabel;
    lblStatusRecord: TLabel;
    edtStatusRecord: TEdit;
    lblMR35FCC2: TLabel;
