...
uses
  Classes, Windows, OverbyteIcswSocket, uBaseDataType, uSockDatatype;
...
type
  ...
  TRecDataPosition = record
    ...
    Heading, Speed, pitch, roll, rudder, fuel: single;
    status: byte;
  end;
  ...
  TRec3DSetExocet_40 = record
    ...
    OpenSeekerPosX    : Double;
    OpenSeekerPosY    : Double;
    OpenHeading       : Single;
  end;
...
const
  ...
  // ------- 76mm ------------
  C_76_BALLISTIC_LOW = 0;
  C_76_BALLISTIC_HIGH = 1;
  REC_CMD_76mm = 7;
  REC_CMD_76SPLASH = 74;
  ORD_CANNON_76_LR = 1;
  ORD_CANNON_76_UD = 2;
  ORD_CANNON_76_F = 3;
  ORD_CANNON_76_DIRECT_LF = 4;
  ORD_CANNON_76_DIRECT_UD = 5;
  ORD_CANNON_76_DIRECT_F = 6;
  ORD_CANNON_76_START_F = 7;
  ORD_CANNON_76_STOP_F = 8;
  ORD_CANNON_76_ASSIGNED = 9;
  ORD_CANNON_76_DEASSIGNED = 10;
  ORD_CANNON_76_AUTOCORREC = 11;
  ...
  C_REC_PACKETNAME: array [1 .. 88] of string =
    ('REC_3D_POSITION', 'REC_POSITION', 'REC_3D_ORDER', 'REC_3D_EXOCET',
    'REC_3D_CHAFF',
  ...
  C_ORDER_STR: array [1 .. C_Max_Order_ID] of string =
    ('select_radar_type', 'start_ICM', 'update_ICM', 'end_ICM', 'init_datum',
    'FOC_plus', 'FOC_minus', 'change_ident', 'assign_tor', 'deassign_tor',
    'assign_asrl', 'deassign_asrl', 'WIPE', 'init_ram', 'assign_ram', '', '',
    'update_SSM', 'assign_SSM', 'deassign_SSM', 'init AUTO',
    'assign_ram_udara', 'init DR', 'init_esm_fix', 'Synch TB',
    'Update Track Pos', 'assign_FC_WCC', 'deassign_FC_WCC', 'fire_gun1',
    'fire_gun2', 'fire_gun3', 'assign_gun', 'deassign_gun', 'assign_FC_OCC',
    'deassign_FC_OCC', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    '', 'Asrock Assign', 'Asrock Deassign', 'Asrock Fire',
...
type
  ...
  TOrdType_FC_command = (STO, SBS, ATO, SBA, RATO, RSTO, break_track,
    open_fire, hold_fire, GenFix, BlindBomb, IndirectBomb, InitTrackSurf,
    AssignTrackSs);
