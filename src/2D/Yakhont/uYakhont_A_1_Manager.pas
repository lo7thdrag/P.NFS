...
var
  Yakhont_A_1_Manager : TYakhont_A_1_Manager;
...
constructor TYakhont_A_1_Manager.Create;
begin
  NetCommLocalClient := TTCPClient.Create;
end;

destructor TYakhont_A_1_Manager.Destroy;
begin
  NetCommLocalClient.Free;
end;

procedure TYakhont_A_1_Manager.BeginSimulation;
begin
  //create Object2-nya
  CreateObject;
  SetLayOutForm;
...
procedure TYakhont_A_1_Manager.EndSimulation;
begin
  Yakhont_A_1_Manager.Free;
end;

procedure TYakhont_A_1_Manager.CreateObject;
begin
...
procedure TYakhont_A_1_Manager.SetLayOutForm;
begin

end;

procedure TYakhont_A_1_Manager.Initialize;
var
  i, n : integer ;
  str : string ;
begin
...
procedure TYakhont_A_1_Manager.Net_Connect;
var
  p : Integer;
begin
...
procedure TYakhont_A_1_Manager.Net_Disconnect;
begin
  ShouldConnect := false;
  NetCommLocalClient.Disconnect;
end;

procedure TYakhont_A_1_Manager.AddToMemoLog(const str: string);
begin
